...
<header class="header-area bg-white">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-2">
                <div class="logo-box">
                    <router-link to="/" class="logo"><img src="../../assets/images/recap-rec.png" alt="logo"></router-link>
                ...
                <div class="menu-wrapper border-left border-left-gray pl-4 justify-content-end">
                    <nav class="menu-bar mr-auto">
                        <ul>
                            ...
                            <li>
                                <a href="#">Caption recommendation <span class="badge bg-warning text-white">New</span></a>
                            </li>
                        </ul><!-- end ul -->
                    </nav><!-- end main-menu -->
                    ...
                    <div class="nav-right-button">
                        <router-link to="/login" class="btn theme-btn theme-btn-outline mr-2"><i class="la la-sign-in mr-1"></i> Login</router-link>
                        <router-link to="/Sign-Up" class="btn theme-btn"><i class="la la-user mr-1"></i> Sign up</router-link>
...
@import url("../../assets/css/selectize.css");
