        ...
        <div class="row">
            <div class="col-lg-2">
               <div class="sidebar pb-45px position-sticky top-0 mt-2">
                   <ul class="generic-list-item generic-list-item-highlight fs-15">
                       <li class="lh-26 active"><a href="home-2.html"><i class="la la-home mr-1 text-black"></i> Caption</a></li>
                       <li class="lh-26"><a href="category.html"><i class="la la-dumbbell mr-1 text-black"></i> Thả thính</a></li>
                       <li class="lh-26"><a href="category.html"><i class="la la-pencil mr-1 text-black"></i> Lời chúc</a></li>
                   </ul>
               </div><!-- end sidebar -->
            </div><!-- end col-lg-2 -->
            <div class="col-lg-7">
                <div class="question-tabs mb-50px">
                    <ul class="nav nav-tabs generic-tabs justify-content-around" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                         ...
                         <li class="nav-item">
                            <a class="nav-link" id="users-tab" data-toggle="tab" href="#users" role="tab" aria-controls="users" aria-selected="false">Thành viên tích cực</a>
                        </li>
                    </ul>
                    <div class="tab-content pt-40px" id="myTabContent">
                        <div class="tab-pane fade show active" id="questions" role="tabpanel" aria-labelledby="questions-tab">
                            <div class="filters d-flex align-items-center justify-content-between pb-4">
                                <h3 class="fs-17 fw-medium">Caption mới nhất</h3>
                                ...
                                <div class="questions-snippet">
                                    <div class="media media-card media--card align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h5><router-link to="/question-details">Hãy yêu một người có thể vì bạn mà làm tất cả… Chứ đừng yêu một người chỉ biết diễn tả tương lai!</router-link></h5>
                                            <small class="meta">
                                    ...
                                    <div class="media media-card media--card align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h5><router-link to="/question-details">Sợ corona thì đừng đi Vũ Hán. Sợ codonqua thì mau tán em đi.</router-link></h5>
                                            <small class="meta">
                                    ...
                                    <div class="media media-card media--card align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h5><router-link to="/question-details">Gió đưa cành trúc la đà. Em xin ba mẹ về nhà anh chưa?</router-link></h5>
                                            <small class="meta">
                                    ...
                                    <div class="media media-card media--card align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h5><router-link to="/question-details">Không hứa thích cậu một đời. Chỉ hứa thích cậu một thời thanh xuân.</router-link></h5>
                                            <small class="meta">
                                    ...
                                    <div class="media media-card media--card align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h5><router-link to="">What is the name of this figure?</router-link></h5>
                                            <small class="meta">
                                    ...
                                    <div class="media media-card media--card align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h5><router-link to="/question-details">Using web3 to call precompile contract</router-link></h5>
                                            <small class="meta">
                                    ...
                                    <div class="media media-card media--card align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h5><router-link to="/question-details">ViewErrorBag Empty - Validation is not passing errors</router-link></h5>
                                            <small class="meta">
                                    ...
                                    <div class="media media-card media--card align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h5><router-link to="/question-details">python: how to change python-config into my current python version</router-link></h5>
                                            <small class="meta">
                                    ...
                                    <div class="media media-card media--card align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h5><router-link to="/question-details">How to calculate running average on tuples being streamed in SQL</router-link></h5>
                                            <small class="meta">
                                    ...
                                    <div class="media media-card media--card align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h5><router-link to="/question-details">Identity Server 4 with .net Core 3.1 -- Identity Server returning token as null</router-link></h5>
                                            <small class="meta">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="media media-card p-3">
                                                <a href="#" class="media-img d-inline-block">
                                                    <img src="../../assets/images/longvb.jpg" alt="company logo">
                                                </a>
                                                <div class="media-body">
                                                    <h5 class="fs-16 fw-medium"><a href="user-profile.html">Vương Bảo Long</a></h5>
                                                    <small class="meta d-block lh-24 pb-1"><span>New York, United States</span></small>
                                                    <p class="fw-medium fs-15 text-black-50 lh-18">1,200 captions</p>
                                                </div><!-- end media-body -->
                                            </div><!-- end media -->
                                        </div><!-- end col-lg-6 -->
                                        <div class="col-lg-12">
            ...
            <div class="col-lg-3">
                <div class="sidebar">
                    <div class="card card-item">
                        <div class="card-body">
                            <h3 class="fs-17 pb-3">Related Captions</h3>
                            ...
                            <div class="sidebar-questions pt-3">
                                ...
                                <div class="media media-card media--card media--card-2">
                                    <div class="media-body">
                                        <h5><router-link to="/question-details">Is it true while finding Time Complexity of the algorithm [closed]</router-link></h5>
                                        <small class="meta">
                                ...
                                <div class="media media-card media--card media--card-2">
                                    <div class="media-body">
                                        <h5><router-link to="/question-details">image picker and store them into firebase with flutter</router-link></h5>
                                        <small class="meta">
                                            <span class="pr-1">1 hour ago</span>
                                            <span class="pr-1">. by</span>
                    ...
                    <div class="card card-item">
                        <div class="card-body">
                            <h3 class="fs-17 pb-3">Trending Captions</h3>
                            <div class="divider"><span></span></div>
                            <div class="sidebar-questions pt-3">
                                <div class="media media-card media--card media--card-2">
                                    <div class="media-body">
                                        <h5><router-link to="/question-details">How did chickenpox get its name?</router-link></h5>
                                        <small class="meta">
                                            <span class="pr-1">2 mins ago</span>
                                            <span class="pr-1">. by</span>
                                            <a href="#" class="author">Sudhir Kumbhare</a>
                                ...
                                <div class="media media-card media--card media--card-2">
                                    <div class="media-body">
                                        <h5><router-link to="/question-details">How can you cut an onion without crying?</router-link></h5>
                                        <small class="meta">
                                            <span class="pr-1">48 mins ago</span>
                                            <span class="pr-1">. by</span>
                                            <a href="#" class="author">wimax</a>
                                ...
                                <div class="media media-card media--card media--card-2">
                                    <div class="media-body">
                                        <h5><router-link to="/question-details">Does flu vaccine protect against Coronavirus?</router-link></h5>
                                        <small class="meta">
                                            <span class="pr-1">1 hour ago</span>
                                            <span class="pr-1">. by</span>
                                            <a href="#" class="author">Antonin gavrel</a>
