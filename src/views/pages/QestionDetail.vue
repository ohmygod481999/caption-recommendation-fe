        ...
        <div class="col-lg-9">
          <div class="question-main-bar mb-50px">
                ...
                <div class="media-body">
                  <h5 class="fs-20">
                    <a href="question-details.html"
                      ...
                      yêu một người chỉ biết diễn tả tương lai!</a
                    >
                  </h5>
                  <div
                    class="
                  ...
                  <div class="tags">
                    <a href="#" class="tag-link">thả thính</a>
                    <a href="#" class="tag-link">xàm</a>
                  </div>
                </div>
              </div>
              <!-- end media -->
            ...
            <div class="answer-wrap d-flex">
              <div class="answer-body-wrap flex-grow-1 pl-0">
                  ...
                  <div class="media media-card user-media align-items-center">
                    ...
                    >
                      <div>
                        ...
                        <div
                          class="stats fs-12 d-flex align-items-center lh-18"
                        >
                          <p class="text-black">Bựa waaa 🤣</p>
                        </div>
                      </div>
                ...
                <div class="comments-wrap">
                          ...
                          >
                            <div>
                              ...
                              <div
                                ...
                                "
                              >
                                <p class="text-black">Bựa bt mà ông 🥱</p>
                              </div>
                            </div>
                            <small class="meta d-block text-right">
                              <span class="text-black d-block lh-18"
                                >answered</span
                              >
                          ...
                          >
                            <div>
                              ...
                              <div
                                ...
                                "
                              >
                                <p class="text-black">Tôi thấy bựa vkl ý</p>
                              </div>
                            </div>
                            <small class="meta d-block text-right">
                              <span class="text-black d-block lh-18"
                  ...
                  <div class="comment-form">
                    <div class="comment-link-wrap text-center">
                      <a
                        class="collapse-btn comment-link"
                          ...
                          <div class="input-box">
                            <div class="form-group">
                              ...
                              >
                                ...
                                <div class="mr-3 font-italic fs-13">
                                  _italic_
                                </div>
                              </div>
                            </div>
            ...
            <div class="post-form">
              <form method="post" class="pt-3">
                <div class="input-box">
                  <label class="fs-14 text-black lh-20 fw-medium"
                    >Comment</label
                  >
                  <div class="form-group">
                    <textarea
                ...
                <div class="sidebar-questions pt-3">
                    ...
                    <div class="media-body">
                      <h5>
                        <a href="question-details.html"
                          ...
                          quá nhiều. Và đừng chờ đợi ai đó quá lâu.</a
                        >
                      </h5>
                      <small class="meta">
                  ...
                  <div class="media media-card media--card media--card-2">
                    <div class="media-body">
                      <h5>
                        <a href="question-details.html"
                          >Tình yêu giống con người khi mặc áo, ít lớp thì
                          lạnh</a
                        >
                      </h5>
                      <small class="meta">
                  ...
                  <div class="media media-card media--card media--card-2">
                    <div class="media-body">
                      <h5>
                        <a href="question-details.html"
                          >Tình mình cứ ngỡ là new chap, ai ngờ lại là new
                          trap</a
                        >
                      </h5>
                      <small class="meta">
            ...
            <div class="card card-item">
              <div class="card-body">
                ...
                <div class="tags pt-4">
                  ...
                  <!-- end tag-item -->
                  <div class="tag-item">
                    <a href="#" class="tag-link tag-link-md">thả thính</a>
                    <span class="item-multiplier fs-13">
                      <span>×</span>
                      <span>32924</span>
                    </span>
