            ...
            <div class="d-flex flex-wrap align-items-center">
              ...
              <div class="search-btn-box mb-3">
                <button class="btn theme-btn">
                  Search <i class="la la-search ml-1"></i>
                </button>
              </div>
              <!-- end search-btn-box -->
            </div>
            <div class="filter-btn-group d-flex flex-wrap align-items-center">
              ...
              <div class="btn-group mr-2 mb-2">
                ...
                >
                  ...
                  >
                    <path
                      d="M8 4.41 6.59 3l-6 6 6 6L8 13.59 3.41 9 8 4.41zm2 0L11.41 3l6 6-6 6L10 13.59 14.59 9 10 4.41z"
                    ></path>
                  </svg>
                  Tech
                </button>
                <div
                  class="
                    dropdown-menu dropdown--menu dropdown--menu-2
                    keep-open
                    mt-3
                  "
                ...
                >
                  <div class="py-3 px-4">
                    ...
                    <!-- end form-group -->
                    <button type="button" class="btn theme-btn theme-btn-sm">
                      Apply filters
                    </button>
                  </div>
                </div>
              ...
              <div class="btn-group mr-2 mb-2">
                <button
                  ...
                  aria-expanded="false"
                >
                  <svg class="mr-1" width="16" height="16" viewBox="0 0 18 18">
                    <path
                    ...
                    ></path>
                    <path
                      d="M9 13.9a1.9 1.9 0 100-3.8 1.9 1.9 0 0 0 0 3.8z"
                    ></path>
                  </svg>
                  Compensation
                </button>
                    ...
                    <div class="form-group">
                      ...
                      <div class="custom-control custom-checkbox fs-14">
                        ...
                        <label
                          ...
                          >Education and tuition benefits</label
                        >
                      </div>
                      <div class="custom-control custom-checkbox fs-14">
                        <input
                      ...
                      <div class="custom-control custom-checkbox fs-14">
                        ...
                        <label
                          ...
                          >Great engineering culture</label
                        >
                      </div>
                      <div class="custom-control custom-checkbox fs-14">
                        <input
              ...
              <div class="btn-group mr-2 mb-2">
                ...
                >
                  ...
                  >
                    <path
                      d="M5 3a2 2 0 00-2 2v10c0 1.1.9 2 2 2h7a2 2 0 002-2V5a2 2 0 00-2-2H5zm2 3a1 1 0 11-2 0 1 1 0 0 1 2 0zm-2 4.5c0-.28.22-.5.5-.5h6a.5.5 0 010 1h-6a.5.5 0 01-.5-.5zm.5 1.5h6a.5.5 0 010 1h-6a.5.5 0 010-1zM5 14.5c0-.28.22-.5.5-.5h6a.5.5 0 010 1h-6a.5.5 0 01-.5-.5z"
                    ></path>
                    <path
                      opacity=".4"
              ...
              <div class="btn-group mr-2 mb-2">
                ...
                >
                  ...
                  >
                    <path
                      d="M3.5 10a1.5 1.5 0 110-3 1.5 1.5 0 0 1 0 3zm5 0a1.5 1.5 0 110-3 1.5 1.5 0 0 1 0 3zM12 8.5a1.5 1.5 0 103 0 1.5 1.5 0 0 0-3 0z"
                    ></path>
                  </svg>
                  More
                </button>
                    ...
                    <div class="form-group">
                      ...
                      <div class="custom-control custom-checkbox fs-14">
                        ...
                        <label
                          ...
                          >Be one of the first applicants</label
                        >
                      </div>
                      <div class="custom-control custom-checkbox fs-14">
                        <input
              ...
              >
                ...
                >
                  <path
                    d="M16 13v1H2v-1l.73-.58c.77-.77.81-3.55 1.19-5.42C4.69 3.23 8 2 8 2a1 1 0 011-1 1 1 0 0 1 1 1s3.39 1.23 4.16 5c.38 1.88.42 4.66 1.19 5.42l.66.58H16zm-7 4a2 2 0 002-2H7a2 2 0 002 2z"
                  ></path>
                </svg>
                Create Alert
              </button>
                      ...
                      <div class="col-lg-12 pt-3">
                        <p class="fs-14">
                          ...
                          <a
                            ...
                            >Join<i class="la la-arrow-right ml-1"></i
                          ></a>
                        </p>
                      </div>
                    </div>
          ...
          >
            ...
            <div class="filter-btn-group d-flex flex-wrap align-items-center">
              ...
              <div
                ...
                "
              >
                <input type="checkbox" class="custom-control-input" id="v" />
                <label
                  class="custom-control-label custom--control-label"
                  for="v"
                  >Visa sponsor</label
              ...
              <div class="jobs-snippet">
                <div class="media media-card">
                  ...
                  <div class="media-body border-left-0">
                    ...
                    <small class="meta d-block lh-20 pb-1">
                      <span class="pr-1"
                        ><i class="la la-map-marker mr-1"></i>Sydney</span
                      >
                      <span
                        ><i class="la la-building mr-1"></i>Internet
                        Classifieds, Real Estate, Web Development</span
                      >
                    </small>
                    <p class="lh-20 fs-13 text-black-50 truncate">
                      Offering the best and hoping to get the same in return: we
                      chose a location in the heart of the city so you can have
                      access to a bunch of good restaurants, we let you chose
                      your hardware to work on, we buy top-of-the-line chairs
                      from Herman Miller and Steelcase (your choice) and
                      standing desks and will keep on trying to make the
                    ...
                    <div class="tags pt-2">
                      ...
                      <a href="#" class="tag-link">node.js</a>
                      <a href="#" class="tag-link active">2 jobs</a>
                    </div>
                  </div>
                </div>
                <!-- end media -->
                <div class="media media-card">
                  ...
                  <div class="media-body border-left-0">
                    ...
                    <div class="tags pt-2">
                      ...
                      <a href="#" class="tag-link">reactjs</a>
                      <a href="#" class="tag-link">node.js</a>
                      <a href="#" class="tag-link active">22 jobs</a>
                    </div>
                  </div>
                </div>
                <!-- end media -->
                <div class="media media-card">
                  ...
                  <div class="media-body border-left-0">
                    ...
                    <div class="tags pt-2">
                      ...
                      <a href="#" class="tag-link">reactjs</a>
                      <a href="#" class="tag-link">node.js</a>
                      <a href="#" class="tag-link active">33 jobs</a>
                    </div>
                  </div>
                </div>
                <!-- end media -->
                <div class="media media-card">
                  ...
                  <div class="media-body border-left-0">
                    ...
                    <div class="tags pt-2">
                      ...
                      <a href="#" class="tag-link">reactjs</a>
                      <a href="#" class="tag-link">node.js</a>
                      <a href="#" class="tag-link active">1 job</a>
                    </div>
                  </div>
                </div>
                <!-- end media -->
